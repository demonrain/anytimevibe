...
export const messages = {
  "zh-CN": {
    ...
    sendShortcut: "发送",
    processing: "远程主机正在处理",
    processingHint: "远程主机正在执行；阶段日志与回复会实时流式同步。点击「停止」可终止本机 CLI 进程。",
    queue: "等待队列",
    cancelQueue: "取消",
    cancelQueueAll: "清空队列",
    deleteTask: "删除",
    deleteTaskConfirm: "删除此任务？将从本机列表移除，之后同步也不会再加载。",
    deleteTaskTitle: "删除任务",
    loadOlder: "加载更早消息",
    loadingOlder: "加载中…",
    composerSettings: "设置",
    composerSettingsClose: "完成",
    actionRequired: "需要操作",
    allowOnce: "允许一次",
    decline: "拒绝",
    lang: "语言",
  ...
  en: {
    ...
    processingHint: "Stage logs and replies stream live. Use Stop to kill the local CLI process.",
    queue: "Queue",
    cancelQueue: "Cancel",
    cancelQueueAll: "Clear queue",
    deleteTask: "Delete",
    deleteTaskConfirm: "Delete this task? It will be removed from this host and skipped on future syncs.",
    deleteTaskTitle: "Delete task",
    loadOlder: "Load earlier messages",
    loadingOlder: "Loading…",
    composerSettings: "Settings",
    composerSettingsClose: "Done",
